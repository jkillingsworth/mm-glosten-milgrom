...
let renderBelief path data =
    ...
    let (value, bid, ask, (pHi, p75, p50, p25, pLo)) = data
    ...
    series.Points.Add(DataPoint(Compute.value75, p75))
    series.Points.Add(DataPoint(Compute.value50, p50))
    series.Points.Add(DataPoint(Compute.value25, p25))
